...
现在 Codex 大概有三个主要入口：
![image](../../../images/MrKmboariocOdoxjas2cDWIPn6d.jpeg)
- Codex CLI
...
咱们一个个来说。
### 第一个是 Codex CLI 。
![image](../../../images/SXKBbBsIxoVxlyxh1oEcO8LynRc.png)
也就是命令行版本。
...
这种不翻车才怪。
### 第二个入口是 Codex App
![image](../../../images/UwJybkGDjoJ1Ntx4Wgxcmr9mnWc.png)
这个我觉得更适合新手。
![image](../../../images/QntwbCg5roftY9xLsJpcLHQjnvb.jpeg)
...
咱们以 VS Code 为例。
![image](../../../images/IeKVbw9BToPnUSxN815cDrc3nAc.png)
直接在插件市场里搜索 `Codex`，安装插件即可。
![image](../../../images/JPBob575yojT4LxRru8c608SnUe.png)
...
### 第一种是 默认权限
![image](../../../images/Ov9rbQ4DPoHEsRx2SwmcQQe0nxf.png)
默认权限最安全，也可以说最保守。
...
毕竟每一步你都得主动确认。
## 第二种是 自动审查模式
![image](../../../images/W09vbhKt4oVJRNxZwX7cJJUPnpc.png)
它比默认权限稍微激进一点。
...
### 第三种是 完全访问权限
![image](../../../images/B0Nrb149KoItyJxNnXHcxHkVnIb.png)
这个模式就要谨慎了。
...
Codex 每个对话都有上下文。
![image](../../../images/Jo0tbpzpfoxaahx6DmRcVpX2n1f.png)
...
![image](../../../images/ZPijbkWodoBYXFxeCOhcCFO5n6b.png)
...
## skills-（目录/技能书/方法)
然后是 skills。
![image](../../../images/HmMdbAgfuoINScxFMhTcFGEwn6c.png)
这个东西有多火，我就不用多说了。
...
## plugins-(工具箱)
再讲 plugins。
![image](../../../images/APsAbHCn1oHB3txk2MZcn0n7nNJ.png)
...
## 自动化
再讲自动化。
![image](../../../images/PxOFbopDGoffBlx6mvZc20cWnM8.png)
这个功能我觉得很多人会低估。
...
先看看最后的实现效果
![image](../../../images/E7qxbhpeEoBEC2xYOsycubzOnEw.png)
...
## 彩蛋
打开之后长这样：
![image](../../../images/LELYbR2FsoQNdIxA3RFc8HHMn5b.png)
里面包含了非常多的 Codex 配置。
...
![image](../../../images/S2j5bVqlDozX5AxVE35cCwMTnhf.png)
里面包含了一大堆宠物，同时也可以自定义宠物。
![image](../../../images/KdwrbW36FoRnYlxfpCDcJXU4nn6.png)
只需要点击「唤醒宠物」，你的宠物就会出现在电脑桌面上。

有一种之前用电脑管家小篮球的即视感。
![image](../../../images/OIkBb4xBvoPgsRxp0z4cNZ7DnRe.jpeg)
如果你感觉 Codex 默认提供的宠物太丑了，现在也有很多 `Codex 宠物市场`。

比如 `https://codex-pets.net/`
![image](../../../images/WppdbBh1KoqZuVxzJincvWlynFe.jpeg)
![image](../../../images/Yf4QbxhWDoOwvlxLzQ5c7WO3nCe.jpeg)
是不是感觉比官方的好看多了。。。

安装也非常简单。

比如安装我最喜欢的 **鸡哥**。
![image](../../../images/M28hbmhltoTTCbx7u1jcGkIQnHe.jpeg)
直接通过右侧的指令即可完成安装 `npx codex-pets add ikun`
![image](../../../images/A3c5bdhkHoxXUvxI8Fzcw8k2neg.jpeg)
当然了，这块就是一个彩蛋。
